...
- `public/mockups/` _(Recommended for new project screenshots)_
- `public/samples/` _(Existing directory where default samples reside)_
...
- `public/mockups/` _(Khuyến nghị tạo mới thư mục này để lưu ảnh screenshot thực tế)_
- `public/samples/` _(Thư mục hiện có chứa các ảnh mẫu)_
